...
<map name="page-14">
    ...
    <?php $id = 140 + $i?>
            <area shape="rect" class="tooltipLink" coords=<?php echo $array[13]["silhouettes"][$i]["coordinates"]?> data-coords=<?php echo $array[13]["silhouettes"][$i]["coordinates"]?> data-id=<?php echo $id ?> data-tooltip="<?php print $array[13]["silhouettes"][$i]["url"] ?>">
    <?php endfor; ?>
</map>